        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-10">
          ...
          <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
            ...
            <input
              type="text"
              placeholder="Name"
              className="w-full h-12 mb-6 px-4 rounded-full border border-gray-200 focus:outline-none shadow-sm"
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              placeholder="Message"
              className="w-full h-24 mb-6 px-4 rounded-lg border border-gray-200 focus:outline-none shadow-sm"
            ></textarea>

            <button className="w-full h-12 bg-indigo-600 text-white rounded-full hover:bg-indigo-800 transition">
              Send
            </button>
          </div>
        </div>
